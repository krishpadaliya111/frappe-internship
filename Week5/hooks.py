...
app_email = "krish.padaliya111@gmail.com"
app_license = "mit"
...
doc_events = {
    "Student": {
        "validate": "student_management.utils.validate_student"
    }
}

doc_events = {
    "Customer": {
        "validate": "student_management.api.set_customer_group_count"
    }
}

scheduler_events = {
    "all": [
        "student_management.tasks.every_few_minutes_task"
    ],
    "hourly": [
        "student_management.tasks.hourly_task"
    ],
    "daily": [
        "student_management.tasks.daily_task"
    ],
    "weekly": [
        "student_management.tasks.weekly_task"
    ],
    "cron": {
        "*/2 * * * *": [
            "student_management.tasks.custom_cron_task"
        ]
    }
}
...
scheduler_events = {
    "daily": [
        "student_management.api.mark_overdue_loans"
    ]
}
